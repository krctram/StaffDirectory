    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 8:
                ...
                ProfilePics = _a.sent();
                return [4 /*yield*/, sp.web.getList(listUrl + "SDGAvailability").items.select("*").orderBy('EndDate', false).top(5000).get()];
            case 9:
                ...
                return [4 /*yield*/, sp.web.getList(listUrl + "StaffDirectory").items.select("*", "User/EMail", "User/Title", "User/FirstName", "User/LastName", "User/JobTitle", "User/UserName", "User/Id", "SDGOfficeDetails/Office", "SDGOfficeDetails/ID").expand("User,SDGOfficeDetails").top(5000).get().then(function (listitem) {
                ...
                case 1:
                    ...
                    UserDetails.forEach(function (details) {
                        ...
                        if (details.Affiliation != "Alumni" && details.Affiliation != "Affiliate") {
                            ...
                            BillingRateTable += "</div></td><td>" + details.JobTitle + "</td>\n    <td><div>" + (details.USDDaily == "" || details.USDDaily == null
                                ? ""
                                ...
                                ? ""
                                : details.OtherCurr + ": " + details.OtherCurrDaily / 8) + "</div></td><td>" + (!details.EffectiveDate ? "Not Available" : new Date(details.EffectiveDate).toLocaleDateString()) + "</td><td>" + (!details.FirstName ? "" : details.FirstName) + "</td><td>" + (!details.LastName ? "" : details.LastName) + "</td><td>" + details.Title + "</td></tr>";
                        }
                    });
...
var useravailabilityDetails = function () { return __awaiter(_this, void 0, void 0, function () {
    var EndDateArr, StartDateArr, modifiedArray, fDateArr, NextArr, StartArr, EndArr, availArr, WeekArr, FinalArr, NextArr1, StartArr1, EndArr1, availArr1, WeekArr1, FinalArr1, availTableHtml, flagnew, checkFlag, k, j, i, Avainewday, Avainewday, Avainewday, checkFlag, k, j, i, Avainewday, Avainewday, Avainewday, Poptions, Poptions;
    return __generator(this, function (_a) {
        EndDateArr = [];
        StartDateArr = [];
        modifiedArray = [];
