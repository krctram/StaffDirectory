...
var onLoadData = function () { return __awaiter(_this, void 0, void 0, function () {
    var LocOptionHtml, LocValueHtml1, LocValueHtml2, staffOptionHtml, otherCurrHtml, StaffFunHtml, StaffDDHtml, StaffAffHtml, AvailProjTypeHtml, AvailPracAreaDD, listLocation, withoutAlumini, listStaffStatus, listOtherCurr, listStaffFunction, listStaffAff, AvailProjectType, AvailPracticeArea, profileliburl;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                $(".loader-section").show();
                LocOptionHtml = "";
                LocValueHtml1 = "<option value='Select'>Select</option>";
                LocValueHtml2 = "<option value='Select'>Select</option>";
                staffOptionHtml = "";
                otherCurrHtml = "";
            ...
            case 7:
                ...
                profileliburl = "/sites/SDGDirectory/ProfilePictures";
                return [4 /*yield*/, sp.web.getFolderByServerRelativeUrl(profileliburl).files.select("*,listItemAllFields").expand("listItemAllFields").get()];
            case 8:
                //var profileliburl=`/sites/StaffDirectory/ProfilePictures`; //for local
                ProfilePics = _a.sent();
                return [4 /*yield*/, sp.web.getList(listUrl + "SDGAvailability").items.select("*", "Editor/Title").expand("Editor").orderBy('EndDate', false).top(5000).get()];
            case 9:
                ...
                return [4 /*yield*/, sp.web.getList(listUrl + "StaffDirectory").items.select("*", "User/EMail", "User/Title", "User/FirstName", "User/LastName", "User/JobTitle", "User/UserName", "User/Id", "SDGOfficeDetails/Office", "SDGOfficeDetails/ID,Editor/Title").expand("User,SDGOfficeDetails,Editor").top(5000).get().then(function (listitem) {
                        ...
                        listitem.forEach(function (li) {
                            ...
                            UserDetails.push({
                                ...
                                ProfilePic: userpic.length > 0 ? userpic[0].ServerRelativeUrl : "/sites/SDGDirectory/SiteImages/profile.png",
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    drpAss = [];
                    arrAssitant = [];
                    return [4 /*yield*/, sp.web.getList(listUrl + "SDGOfficeInfo").items.filter("AlumniOffice eq '" + false + "'").get()];
                case 1:
                    ...
                    UserDetails.forEach(function (avli) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            // console.log(avli);
                    ...
                    UserDetails.forEach(function (details) {
                        ...
                        if (details.Affiliation == "Employee") {
                            if (details.LastName != "") {
                                ...
                                EmpTable += "</div></td><td>" + details.FirstName + "</td><td>" + details.LastName + "</td><td>" + ViewPhoneNumber.join("<br>") + "</td><td>" + (details.Location == "" || details.Location == null
                                    ? "Not Available"
                                    : "" + details.Location) + "</td><td>" + (details.JobTitle == "" || details.JobTitle == null
                                    ? "Not Available"
                                    : "" + details.JobTitle) + "</td><td>" + details.Title + "</td><td style=\"display:none;;\">" + (details.Assistant == "" || details.Assistant == null
                                    ? "Not Available"
                        ...
                        if (details.Affiliation == "Independent Contractor") {
                            if (details.LastName != "") {
                                ...
                                OutTable += "</div></td><td>" + details.FirstName + "</td><td>" + details.LastName + "</td><td>" + ViewPhoneNumber.join("<br>") + "</td><td>" + (details.Location == "" || details.Location == null
                                    ? "Not Available"
                                    : "" + details.Location) + "</td><td>" + (details.JobTitle == "" || details.JobTitle == null
                                    ? "Not Available"
                                    : "" + details.JobTitle) + "</td><td>" + (details.Title == "" || details.Title == null
                                    ? "Not Available"
                                    : "" + details.Title) + "</td><td style=\"display:none;\">" + (details.Assistant == "" || details.Assistant == null
                                    ? "Not Available"
                                    : "" + details.Assistant) + "</td></tr>";
                            }
                            else {
                        ...
                        if (details.Affiliation != "Alumni" && details.Affiliation != "Affiliate") {
                            ...
                            BillingRateTable += "</div></td><td class=\"w100\">" + details.JobTitle + "</td>\n    <td><div>" + (details.USDDaily == "" || details.USDDaily == null
                                ? ""
                                ...
                                ? ""
                                : details.OtherCurr + ": " + details.OtherCurrDaily / 8) + "</div></td><td>" + (!details.EffectiveDate ? "Not Available" : new Date(details.EffectiveDate).toLocaleDateString()) + "</td><td>" + (!details.FirstName ? "" : details.FirstName) + "</td><td data-sort=" + details.LastName + ">" + (!details.LastName ? "" : details.LastName) + "</td><td>" + details.Title + "</td></tr>";
                        }
                    });
                    ...
                    $("#searchStaffAssitant").autocomplete({
                        source: arrAssitant,
...
var LoadProfile = function (e) { return __awaiter(_this, void 0, void 0, function () {
    var sdhEmp, Edit, viewBiling, userpage, Modi, pemailarr, pemailHTML, htmlforPhoneNumber, phnoval, htmlforHomeNo, Homenoval, htmlforEmergencyNo, Emnoval, addressHTML, billingRateHtml, USDHourly, EURHourly, OtherCurrHourly, filesHtml, editfileHtml, files, editfMonth, editfday, Sdd, Smm, Syyyy, Sdateformat;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                Modi = moment(SelectedUserProfile[0].Modified).format("DD/MM/YYYY");
...
var editsubmitFunction = function () { return __awaiter(_this, void 0, void 0, function () {
    var mobNumUpdate, homeNumUpdate, emergencyNumUpdate, officeNumUpdate, mobNumbers, homeNumbers, emergencyNumbers, officeNumbers, FolderUrl, dispTitle, pickerDiv, peoplePicker, userInfo, profileID, loginName, profile, strIndustry, strELanguage, strESDGCourse, strESoftwarExp, strEMembership, strESKnowledge, strShortbio, insertObj, update, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                mobNumUpdate = "";
                ...
                FolderUrl = "/sites/SDGDirectory/BiographyDocument/" + selectedUsermail;
...
var useravailabilityDetails = function () { return __awaiter(_this, void 0, void 0, function () {
    var EndDateArr, StartDateArr, modifiedArray, fDateArr, NextArr, StartArr, EndArr, availArr, WeekArr, FinalArr, NextArr1, StartArr1, EndArr1, availArr1, WeekArr1, FinalArr1, myarray, ModiAvail, ModifiedBy, availTableHtml, flagnew, checkFlag, k, j, i, Avainewday, Avainewday, Avainewday, checkFlag, k, j, i, Avainewday, Avainewday, Avainewday, Poptions, Poptions;
    return __generator(this, function (_a) {
        EndDateArr = [];
        StartDateArr = [];
        modifiedArray = [];
        ...
        myarray.sort(function (a, b) { return new Date(b.Modified) - new Date(a.Modified); });
        ModiAvail = moment(myarray[0].Modified).format("DD/MM/YYYY");
        ModifiedBy = myarray[0].Editor.Title;
        ...
        if (SelectedUserProfile[0].Availability != 0 && SelectedUserProfile[0].Availability > 0) {
            ...
            if (EndDateArr.length > 0) {
                ...
                for (i = 0; i < availArr.length; i++) {
                    if (new Date(availArr[0]).getDay() == 0) {
                        Avainewday = moment(availArr[0]).add(1, 'days').format("MM/DD/YYYY");
                        ...
                        Avainewday = moment(availArr[0]).add(2, 'days').format("MM/DD/YYYY");
                        //$('.todayAvail').html(`<label>Next 100% available on : ${new Date(<any>Avainewday).toLocaleDateString()}</label>`)
                        if (IsAdminStaff || (SelectedUserProfile[0].Usermail.toLowerCase() == currentMail.toLowerCase() && IsgeneralStaff))
                            $('.todayAvail').html("<label style=\"top: -3rem;\">Next 100% available on : " + Avainewday + "</label>");
                        else
                        ...
                        Avainewday = moment(availArr[0]).format("MM/DD/YYYY");
            ...
            if (EndDateArr.length > 0) {
                ...
                for (i = 0; i < availArr1.length; i++) {
                    if (new Date(availArr1[0]).getDay() == 0) {
                        Avainewday = moment(availArr1[0]).add(1, 'days').format("MM/DD/YYYY");
                        ...
                        Avainewday = moment(availArr1[0]).add(2, 'days').format("MM/DD/YYYY");
                        //$('.NextAvail').html(`<label>Next 100% available on : ${new Date(<any>Avainewday).toLocaleDateString()}</label>`)
                        if (IsAdminStaff || (SelectedUserProfile[0].Usermail.toLowerCase() == currentMail.toLowerCase() && IsgeneralStaff))
                            $('.NextAvail').html("<label style=\"top: -5rem;\">Next 100% available on : " + Avainewday + "</label>");
                        else
                        ...
                        Avainewday = moment(availArr1[0]).format("MM/DD/YYYY");
                        if (IsAdminStaff || (SelectedUserProfile[0].Usermail.toLowerCase() == currentMail.toLowerCase() && IsgeneralStaff))
                            $('.NextAvail').html("<label style=\"top: -5rem;\">Next 100% available on : " + Avainewday + "</label>");
                        else
                            $('.NextAvail').html("<label style=\"top: -2rem;\">Next 100% available on : " + Avainewday + "</label>");
