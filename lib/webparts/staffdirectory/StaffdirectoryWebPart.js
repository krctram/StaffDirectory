    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 9:
                ...
                return [4 /*yield*/, sp.web.getList(listUrl + "StaffDirectory").items.select("*", "User/EMail", "User/Title", "User/FirstName", "User/LastName", "User/JobTitle", "User/UserName", "User/Id", "SDGOfficeDetails/Office", "SDGOfficeDetails/ID").expand("User,SDGOfficeDetails").get().then(function (listitem) {
